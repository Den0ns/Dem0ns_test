<?php 
	use yii\helpers\URL;	
	use yii\helpers\Saety2;	
	$o = new Saety2( '4056961707', 'd0a0546191aaba13253711c54b4f2c4e');
	$code_url = $o->getAuthorizeURL('http://www.xylagou.com/web/index.php');
?>
<!DOCTYPE HTML>
<html>
<head>
...
<body id="login_bg">
	<div class="login_wrapper">
		<div class="login_header">
        	<a href="<?= URL::to(['index/index'])?>"><img src="style/images/logo_white.png" width="285" height="62" alt="拉勾招聘" /></a>
    	...
    	<input type="hidden" id="resubmitToken" value="" />		
		 <div class="login_box">
			...
			<div class="login_right">
				<div>还没有拉勾帐号？</div>
				<a  href="<?= URL::to(['login/register'])?>"  class="registor_now">立即注册</a>
